...
class {{ContainerName}} extends Component {
  ...
  notifyChange = key => value => {
    ...
    this.notify('{{appNamespace}}/updateFormInfo', payload);
  ...
  clearError = (currentValue, keyPathInErrorInfo) => {
    ...
    if (currentValue && currentError) {
      ...
      this.notify('{{appNamespace}}/clearError', payload);
    }
  };

  save = () => {
    this.notify('{{appNamespace}}/save');
  };

  cancel = () => {
    this.notify('{{appNamespace}}/cancel');
  };
